// // File: src/components/nonnon-fictionCategories.js
// // ==================================================
// // PAGE: Books for a selected nonnon-fiction category (e.g., /nonnon-fiction/biography)
// //
// // Layout:
...
// import "./NonNon-fictionPage.css"; // reuse styling for consistency

// /* ---------------- Dummy nonnon-fiction Books Data ----------------
//    Each category has 10 books.
//    Fields: title, author, publisher, stock, overview, review
// ---------------------------------------------------------------- */
// const rawnonnon-fictionBooks = {
//   biography: [
//     {
...
// /* Categories list (matches nonnon-fictionPage.js routes) */
...
// export default function NonNon-fictionCategories() {
//   const { category } = useParams(); // get /nonnon-fiction/:category
//   const navigate = useNavigate();
//   const location = useLocation();

//   const key = (category || "").toLowerCase();
//   const books = rawnonnon-fictionBooks[key] || [];
...
//   return (
//     <div
//       className="nonnon-fiction-container"
//       style={{
//         minHeight: "100vh",
...
//       }}
//     >
//       <div className="nonnon-fiction-overlay" />

//       {/* ---------------- Layout: Left panel + Right content ---------------- */}
//       <div className="nonnon-fiction-categories-container">
//         <div className="nonnon-fiction-layout">

//           {/* ---------------- LEFT PANEL ---------------- */}
//           <aside className="nonnon-fiction-left-panel">
//              {/* Dashboard button */}
//             <div className="nonnon-fiction-dashboard-link">
//               <button 
//               className="nonnon-fiction-dashboard-button" 
...
//             {/* Categories list */}
//             <h3 className="nonnon-fiction-left-title" style={{ marginTop: 8 }}>
//               Non Non-fiction Categories
//             </h3>
//             <ul className="nonnon-fiction-left-categories">
//               {categoriesList.map((cat) => (
//                 <li key={cat}>
//                   <Link
//                     to={`/nonnon-fiction/${cat}`}
//                     className="nonnon-fiction-category-link"
//                   >
//                     {displayName(cat)}
//                   </Link>
//                 </li>
...
//           {/* ---------------- RIGHT CONTENT ---------------- */}
//           <section className="nonnon-fiction-right-content">
//             {/* Category heading */}
//             <h2
//               className={`nonnon-fiction-category-title ${
...
//             ) : (
//               <div className="nonnon-fiction-shelves">
//                 {/* Book grid: 9 slots per shelf (3 per row) */}
//                 <div className="nonnon-fiction-book-grid">
//                   {books.map((b, idx) => (
...
//                       <div
//                         key={`empty-${idx}`}
//                         className="nonnon-fiction-book-slot empty"
//                       />
//                     )
//                   )}
//                 </div>
...
// import dashboardBg from "./image/dashboard-bg.jpg";
// import "./NonNon-fictionPage.css";

// const categoriesList = [
//   "biography", "selfhelp", "history", "science", "philosophy", "travel", "truecrime",
// ];
...
//   const key = (category || "").toLowerCase();
//   const normalizedKey = key.replace(/-/g, " "); // e.g., "true-crime" becomes "true crime"
...
//       })
//       .then((data) => {
//         // Filter: Must be Non-Non-fiction AND match category
//         const filteredBooks = data.filter(b => 
//           b.section?.toLowerCase() === "non-non-fiction" && 
...
//           <aside className="nonnon-fiction-left-panel">
//             <div className="nonnon-fiction-dashboard-link">
//               <button className="nonnon-fiction-dashboard-button" onClick={() => navigate("/dashboard")}>
//                 Dashboard
//               </button>
//             </div>
//             <h3 className="nonnon-fiction-left-title" style={{ marginTop: 8 }}>
...
//               {categoriesList.map((cat) => (
//                 <li key={cat}>
//                   <Link to={`/nonnon-fiction/${cat}`} className="nonnon-fiction-category-link">
//                     {displayName(cat)}
//                   </Link>
//                 </li>
//               ))}
...
//           {/* ---------------- RIGHT CONTENT ---------------- */}
//           <section className="nonnon-fiction-right-content">
//             <h2 className={`nonnon-fiction-category-title ${key === "philosophy" ? "philosophy-heading" : ""}`}>
//               {key ? `${displayName(key)} Books` : "Select a category"}
//             </h2>
...
//                 {!loading && !error && books.length === 0 && <p>No books available in this category yet.</p>}
...
//                     ))}
//                     {/* Empty slots to fill complete grid */}
//                     {Array.from({ length: (9 - (books.length % 9)) % 9 }).map((_, idx) => (
//                       <div key={`empty-${idx}`} className="nonnon-fiction-book-slot empty" />
//                     ))}
//                   </div>
//                 )}
//               </div>
...
// import Book from "./Book"; 
// import dashboardBg from "./image/dashboard-bg.jpg";
// import "./NonNon-fictionPage.css"; // Reuse your existing styling

// const nonNon-fictionCategories = [
...
//     // Fetch books filtered for Non-Non-fiction
//     fetch(`http://localhost:5000/api/books`)
//       .then((res) => res.json())
//       .then((data) => {
...
//     // Get current borrowing count from DB
//     if (user.id) {
...
//       alert("Limit Reached: You can only have 5 books total.");
//       return;
//     }

//     const updatedCart = [...currentCart, book];
//     localStorage.setItem("cart", JSON.stringify(updatedCart));
//     window.dispatchEvent(new Event("storage")); // Sync with TopBar
//     alert(`${book.title} added to cart!`);
//   };

//   return (
//     <div className="non-fiction-container"> {/* Reusing the layout class */}
//       <div className="non-fiction-layout">
//         <aside className="non-fiction-left-panel">
//           <button onClick={() => navigate("/dashboard")}>Dashboard</button>
//           <h3>Non-Non-fiction</h3>
//           <ul className="non-fiction-left-categories">
//             {nonNon-fictionCategories.map((cat) => (
//               <li key={cat}>
//                 <Link to={`/non-non-fiction/${cat}`}>{displayName(cat)}</Link>
//               </li>
//             ))}
//           </ul>
//         </aside>
//         <section className="non-fiction-right-content">
//           <h2>{displayName(key)}</h2>
//           <div className="non-fiction-book-grid">
//             {books.map((book, index) => (
//               <Book key={index} book={book} onAddToCart={handleAddToCart} />
//             ))}
//           </div>
//         </section>
//       </div>
