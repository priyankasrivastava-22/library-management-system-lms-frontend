...
//       })
//       .then((data) => {
//         // Filter: Must be Study AND match category
...
//           {/* ---------------- RIGHT CONTENT ---------------- */}
//           <section className="study-right-content">
//             <h2 className={`study-category-title ${key === "chemistry" ? "fantasy-heading" : ""}`}>
//               {key ? `${displayName(key)} Books` : "Select a category"}
//             </h2>
...
//                       <div key={`empty-${idx}`} className="study-book-slot empty" />
//                     ))}
//                   </div>
//                 )}
//               </div>
...
//               <li key={cat}>
//                 <Link to={`/study/${cat}`}>{displayName(cat)}</Link>
//               </li>
//             ))}
//           </ul>
//         </aside>
//         <section className="study-right-content">
//           <h2>{displayName(key)} Resources</h2>
//           <div className="study-book-grid">
